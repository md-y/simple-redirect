...
/**
 * Opens a web browser and navigates to the target url and awaits a request to the callback url.
...
export const redirect = (
    ...
    return new Promise((resolve, reject) => {
        ...
        server.listen({ host: callbackUrl.host, port: !callbackUrl.port ? '80' : callbackUrl.port });
